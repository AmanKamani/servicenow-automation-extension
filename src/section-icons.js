const SECTION_ICONS = {
  templates: [
    'M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 000 2h8a1 1 0 100-2H6zm0 3a1 1 0 000 2h4a1 1 0 100-2H6z',
  ],
  flows: [
  ...
  payload: [
    ...
    'M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3z',
  ],
  "field-config": [
  ...
  "flow-templates": [
    'M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zm-2 4a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z',
  ],
};

function buildSvg(key, paths) {
  const svg = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  svg.setAttribute("viewBox", "0 0 20 20");
  svg.setAttribute("fill", "currentColor");
  svg.classList.add("section-icon", "section-icon-" + key);
  paths.forEach((d) => {
...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll("[data-section-icon]").forEach((el) => {
    const key = el.getAttribute("data-section-icon");
    const paths = SECTION_ICONS[key];
    if (!paths) return;
    el.prepend(buildSvg(key, paths));
  });
});
